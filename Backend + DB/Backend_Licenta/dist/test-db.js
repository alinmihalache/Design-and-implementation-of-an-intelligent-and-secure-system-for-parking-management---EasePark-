...
async function testDatabase() {
    ...
    `);
        ...
        const userTables = tablesResult.rows.filter(t => t.table_name.toLowerCase().includes('user') ||
      ...
      `, [tableName]);
            ...
            const testUser = await client.query(`SELECT * FROM ${tableName} WHERE username = $1`, ['test']);
